...
public class HospitalController {
	...
	public ResponseStructure<Hospital> saveHospital(@RequestBody Hospital user) {
		return hospitalService.saveHospital(user);
	...
	public ResponseStructure<Hospital> updateHospital(@RequestBody Hospital user, @PathVariable int id) {
		return hospitalService.updateHospital(user, id);
